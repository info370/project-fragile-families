...
finalCombined[,names] <- lapply(finalCombined[,names], as.numeric) 

#select all survey questions and the outcome variable, filter out negative numbers
otherDummyVars <- select(finalCombined, m1a11b, m3c3h, m3b4d, m4b4a1, t5c13c) %>% filter(f5k14d >= 0, m3c3h >= 0, t5c13c >= 0, t5c13c < 6, m1a11b > 0, m3b4d > 0, m4b4a1 > 0)

finalCombined$f5k14d
...
everythingSet <- combine4

everythingSet2 <- everythingSet
everythingSet2[everythingSet2 < 0 ] <- NA
