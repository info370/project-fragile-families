...
ggplot(data = parent_involvement, aes(x = score, y = tally)) + geom_point() + geom_jitter(width = 0.2) +
  geom_smooth(method = "lm", color="black", aes(group=1))

cor(parent_involvement$score,parent_involvement$tally)
...
features3 <- c('m4c3a',	'm4c3b',	'm4c3c',	'm4c3d',	'm4c3e',	'm4c3f','m4c3g',	'm4c3h','f4b4a1',	'f4b4a2',	'f4b4a3',	'f4b4a4',	'f4b4a5',	'f4b4a6',	'f4b4a7',	'f4b4a8',	'f4c3a',	'f4c3b',	'f4c3c',	'f4c3d',	'f4c3e',	'f4c3f',	'f4c3g',	'f4c3h')
...
ggplot2.violinplot(data=parent_involvement2, xName='score',yName='tally', addDot=FALSE, addMean=TRUE)
